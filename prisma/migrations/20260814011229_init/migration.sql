...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'PAYMENT_CONFIRMED', 'PROCESSING', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'PAYMENT_FAILED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_flutterwaveTxnId_key" ON "Payment"("flutterwaveTxnId");
