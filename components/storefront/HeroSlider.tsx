...
const SLIDES: SlideData[] = [
  {
    ...
    subtitle: "100% virgin human hair, crafted for queens.",
  ...
  {
    id: 2,
    title: "Flawless from Every Angle.",
    subtitle: "Discover textures that move seamlessly with you.",
  ...
  },
  {
    ...
    subtitle: "Premium units delivered within 24 hours.*",
